...
INSERT INTO `category` VALUES (1,'favourites'),(2,'low-calories'),(3,'vegan'),(4,'other'),(13,'dessert');
...
INSERT INTO `course` VALUES (1,'breakfast'),(2,'dinner'),(3,'lunch'),(4,'snack');
...
INSERT INTO `ingredients` VALUES (1,'soap'),(2,'grass'),(3,'sawdust');
...
CREATE TABLE `recipe` (
  ...
  `r_description` varchar(45) DEFAULT NULL,
  ...
  KEY `r_course_id_idx` (`r_course_id`),
  CONSTRAINT `r_category_id` FOREIGN KEY (`r_category_id`) REFERENCES `category` (`r_category_id`),
  CONSTRAINT `r_course_id` FOREIGN KEY (`r_course_id`) REFERENCES `course` (`course_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `recipe` VALUES (1,'stew','iiitt',10,0,3,1),(2,'salad','sdad',5,1,2,1),(3,'pasta','dsad',20,1,3,3);
...
INSERT INTO `steps` VALUES (1,1,2,'55g',1,'isdad'),(2,1,3,'5g',2,'text'),(3,2,1,'532g',1,'sadasd');
...
-- Dump completed on 2022-03-24 18:06:54
